...
class MyHabbitTile extends StatelessWidget {
  final String text;
  ...
  const MyHabbitTile({super.key, required this.text, required this.isCompleted, required this.onChanged, this.editHabit, this.deleteHabit});
